...
class EditEventTimestampNode(Node):
    ...
    async def handle_event_timestamp(self, update: Update, user_to_state: UsersToState, new_state: UserState):
        ...
        # TODO handle cancel? --> add via node transition directly
        ...
        event_summary = # TODO via prettyPrint event Object, match case
        new_inline_message = UpdateEventUtils.get_inline_message('Updated', self.event_type, event_summary)
