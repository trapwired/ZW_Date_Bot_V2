...
class TrainingAttendance(object):
    ...
    def from_dict(doc_id: str, source: dict):
        return TrainingAttendance(source['playerId'], source['gameId'], source['state'], doc_id)
    ...
    def __repr__(self):
        return f"TrainingAttendance(playerId={self.player_id}, gameId={self.game_id}, state={self.state}, doc_id={self.doc_id})"
