...
The pending update an admin types is staged in their state's ``additional_info``
(the admin-menu message to keep re-rendering, plus the URL - see build_pending);
